"""
Fixed-network baseline for the Phase 2 continual-learning benchmark.
"""
...
@dataclass
class FixedNetwork:
    """Single linear layer with online updates and no structural adaptation."""
...
def run_experiment(seed: int = 7) -> dict:
    model = FixedNetwork(in_size=4, out_size=2, lr=0.05, seed=seed)
    ...
    results_dir = get_results_path("baseline_fixed")
